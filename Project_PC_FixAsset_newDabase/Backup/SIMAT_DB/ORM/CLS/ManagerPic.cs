...
{
	sealed public class ManagerPic
	{
        ...
        static ManagerPic()
        {
            try
            {
                ...
                //string connectString = "Server=Ngohjung;DataBase=simatPicDB;UID=sa;PWD=;";
      ...
      public  static void FunctionTestConnect()
        {
            try
            {
