...
{
	sealed public class ManagerPicCantConnect
	{
        ...
        public static string Str_ConfigFileName = AppDomain.CurrentDomain.BaseDirectory + "Data\\Server\\DB-ServerPicture.Xml";
        ...
        {
            get { return ManagerPicCantConnect.engine; }
        }

        static ManagerPicCantConnect()
        {

        }

        public static void Function_StartApplication()
        {
            try
            {
                string mappingFile = AppDomain.CurrentDomain.BaseDirectory + "ORM\\Config\\Mappings.config";

                //"Server=NAUNG\\SQLEXPRESS;DataBase=simatDB;UID=sa;PWD=sa;";
