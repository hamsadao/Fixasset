...
namespace System.Windows.Forms.Samples
{
	...
	public partial class LeftSpine : UserControl
	{
        ...
        {
            return SimatSoft.FixAsset.Properties.Resources.ResourceManager.GetObject(name) as Bitmap;
        }
		#endregion
        ...
        private void folderView1_DoubleClick(object sender, EventArgs e)
        {
          
            
        }

        private void folderView1_Load(object sender, EventArgs e)
        {

        }

        private void folderView1_Changed(object sender, EventArgs e)
        {
             
        }

        private void folderView1_DoubleClick_1(object sender, EventArgs e)    
        {
