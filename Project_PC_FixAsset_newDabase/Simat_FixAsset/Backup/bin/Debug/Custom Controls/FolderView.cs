...
namespace System.Windows.Forms.Samples
{
	public class FolderView : System.Windows.Forms.UserControl
	{
		...
		private void InitializeComponent()
		{
            ...
            treeNode16,
            treeNode18});
            this.folderTreeView.SelectedImageIndex = 7;
        ...
        public void add_node(string keyid,string text,int Imageindex ) {
               folderTreeView.Nodes.Add(keyid ,text ,Imageindex );
   
        }
        public void add_node(string parentkey ,string keyid, string text, int Imageindex)
        {
            folderTreeView.Nodes[parentkey].Nodes.Add(keyid, text, Imageindex);     

        }

        public  void  folderTreeView_DoubleClick(object sender, EventArgs e)
        {
